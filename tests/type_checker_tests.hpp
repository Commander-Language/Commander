...
INSTANTIATE_TEST_SUITE_P(
        TypeCheckerTestFiles, TypeCheckerPassTests,
        ::testing::Values(
                ...
                std::make_tuple("300.cmdr", "300.cmdr.expected"), std::make_tuple("301.cmdr", "301.cmdr.expected"),
                std::make_tuple("302.cmdr", "302.cmdr.expected"), std::make_tuple("303.cmdr", "303.cmdr.expected"),
                std::make_tuple("304.cmdr", "304.cmdr.expected"), std::make_tuple("305.cmdr", "305.cmdr.expected"),
                std::make_tuple("306.cmdr", "306.cmdr.expected"), std::make_tuple("307.cmdr", "307.cmdr.expected"),
                std::make_tuple("308.cmdr", "308.cmdr.expected"), std::make_tuple("309.cmdr", "309.cmdr.expected"),
                std::make_tuple("310.cmdr", "310.cmdr.expected"), std::make_tuple("311.cmdr", "311.cmdr.expected"),
                std::make_tuple("312.cmdr", "312.cmdr.expected"), std::make_tuple("313.cmdr", "313.cmdr.expected"),
                std::make_tuple("314.cmdr", "314.cmdr.expected"), std::make_tuple("315.cmdr", "315.cmdr.expected"),
                std::make_tuple("316.cmdr", "316.cmdr.expected"), std::make_tuple("317.cmdr", "317.cmdr.expected"),
                std::make_tuple("318.cmdr", "318.cmdr.expected"), std::make_tuple("319.cmdr", "319.cmdr.expected"),
                std::make_tuple("320.cmdr", "320.cmdr.expected"), std::make_tuple("321.cmdr", "321.cmdr.expected"),
                std::make_tuple("322.cmdr", "322.cmdr.expected"), std::make_tuple("323.cmdr", "323.cmdr.expected"),
                std::make_tuple("324.cmdr", "324.cmdr.expected"), std::make_tuple("325.cmdr", "325.cmdr.expected"),
                std::make_tuple("326.cmdr", "326.cmdr.expected"), std::make_tuple("327.cmdr", "327.cmdr.expected"),
                std::make_tuple("328.cmdr", "328.cmdr.expected"), std::make_tuple("329.cmdr", "329.cmdr.expected"),
                std::make_tuple("330.cmdr", "330.cmdr.expected"), std::make_tuple("331.cmdr", "331.cmdr.expected"),
                std::make_tuple("332.cmdr", "332.cmdr.expected"), std::make_tuple("333.cmdr", "333.cmdr.expected"),
                std::make_tuple("334.cmdr", "334.cmdr.expected"), std::make_tuple("335.cmdr", "335.cmdr.expected"),
                std::make_tuple("336.cmdr", "336.cmdr.expected"), std::make_tuple("337.cmdr", "337.cmdr.expected"),
                std::make_tuple("338.cmdr", "338.cmdr.expected"), std::make_tuple("339.cmdr", "339.cmdr.expected"),
                std::make_tuple("340.cmdr", "340.cmdr.expected"), std::make_tuple("341.cmdr", "341.cmdr.expected"),
                std::make_tuple("342.cmdr", "342.cmdr.expected"), std::make_tuple("343.cmdr", "343.cmdr.expected"),
                std::make_tuple("344.cmdr", "344.cmdr.expected"), std::make_tuple("345.cmdr", "345.cmdr.expected"),
                std::make_tuple("346.cmdr", "346.cmdr.expected"), std::make_tuple("347.cmdr", "347.cmdr.expected"),
                std::make_tuple("348.cmdr", "348.cmdr.expected"), std::make_tuple("349.cmdr", "349.cmdr.expected"),
                std::make_tuple("350.cmdr", "350.cmdr.expected"), std::make_tuple("351.cmdr", "351.cmdr.expected"),
                ...
                std::make_tuple("360.cmdr", "360.cmdr.expected")));
 ...
 */
INSTANTIATE_TEST_SUITE_P(
        TypeCheckerTestFiles, TypeCheckerFailTests,
        ::testing::Values(
                ...
                "128.cmdr", "129.cmdr", "130.cmdr", "131.cmdr", "132.cmdr", "133.cmdr", "134.cmdr", "135.cmdr",
                "136.cmdr", "137.cmdr", "138.cmdr", "139.cmdr", "140.cmdr", "141.cmdr", "142.cmdr", "143.cmdr",
                "144.cmdr", "145.cmdr", "146.cmdr", "147.cmdr", "148.cmdr", "149.cmdr", "150.cmdr", "151.cmdr",
                "152.cmdr", "153.cmdr", "154.cmdr", "155.cmdr", "156.cmdr", "157.cmdr", "158.cmdr", "159.cmdr",
                "160.cmdr", "161.cmdr", "162.cmdr", "163.cmdr", "164.cmdr", "165.cmdr", "166.cmdr", "167.cmdr",
                "168.cmdr", "169.cmdr", "170.cmdr", "171.cmdr", "172.cmdr", "173.cmdr", "174.cmdr", "175.cmdr",
                "176.cmdr", "177.cmdr", "178.cmdr", "179.cmdr", "180.cmdr", "181.cmdr", "182.cmdr", "183.cmdr",
                ...
                "208.cmdr", "209.cmdr", "210.cmdr", "211.cmdr", "212.cmdr", "213.cmdr", "214.cmdr", "215.cmdr",
                "216.cmdr", "217.cmdr", "218.cmdr", "219.cmdr", "220.cmdr", "221.cmdr", "222.cmdr", "223.cmdr",
                "224.cmdr", "225.cmdr", "226.cmdr", "227.cmdr", "228.cmdr"));
