...
/**
 * @brief Represents the format for lexer tests. Tests take in a file path to file to lex, and another file path to file with expected token output.
 */
...
INSTANTIATE_TEST_SUITE_P(
    ...
    LexerTests,
    ::testing::Values(
        std::make_tuple("000.cmdr", "000.cmdr.output"),
