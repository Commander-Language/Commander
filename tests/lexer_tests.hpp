...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                ...
                std::make_tuple("087.cmdr", "087.cmdr.expected"), std::make_tuple("088.cmdr", "088.cmdr.expected"),
                std::make_tuple("089.cmdr", "089.cmdr.expected"), std::make_tuple("090.cmdr", "090.cmdr.expected"),
                std::make_tuple("091.cmdr", "091.cmdr.expected"), std::make_tuple("092.cmdr", "092.cmdr.expected")));
