...
private:
    std::vector<Scope*> _symbolTables{}; //A vector containing each symbol table; some methods will use this to find a value while others will rely on scope's recursiveness
};
