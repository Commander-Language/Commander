    ...
    std::vector<std::tuple<GrammarRule, Grammar::NodeConstructor>> Grammar::_defineGrammar() {
        ...
        return flatten({
                ...
                {{{ASTNodeType::STMT,
                  ...
                  makeNode("ForStmt",
                           {firstTokenPosition, castNode("Expr", 2), makeNode("BoolExpr", {tokenPosition(4), "true"}),
                ...
                {{{ASTNodeType::STMT,
                  ...
                  makeNode("ForStmt",
                           {firstTokenPosition, castNode("Expr", 2), makeNode("BoolExpr", {tokenPosition(4), "true"}),
                            castNode("Expr", 5), castNode("Stmt", 7)})}},
                ...
                {{{ASTNodeType::STMT,
                  ...
                  makeNode("ForStmt", {firstTokenPosition, castNode("Expr", 2), castNode("Expr", 4), "nullptr",
                                       castNode("Stmt", 7)})}},
                ...
                {{{ASTNodeType::STMT,
                  ...
                  makeNode("ForStmt", {firstTokenPosition, castNode("Expr", 2), castNode("Expr", 4),
                                       castNode("Expr", 6), castNode("Stmt", 8)})}},
                ...
                {{{ASTNodeType::TYPES, {ASTNodeType::TYPES, TokenType::COMMA, ASTNodeType::TYPE}},
