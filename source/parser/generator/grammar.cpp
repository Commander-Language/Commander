...
#pragma ide diagnostic ignored "cppcoreguidelines-avoid-magic-numbers"
    std::vector<std::tuple<Grammar::GrammarRule, Grammar::NodeConstructor>> Grammar::_definePrototypeGrammar() {
        return {//  PRGM -> STMT
                ...
                //  EXPR -> "[TRUE]"
                {{ASTNodeType::EXPR, {TokenType::TRUE}}, "return std::make_shared<BoolExprNode>(true);"},
                //  EXPR -> "[FALSE]"
                {{ASTNodeType::EXPR, {TokenType::FALSE}}, "return std::make_shared<BoolExprNode>(false);"},
                ...
                {{ASTNodeType::EXPR,
                 ...
                 "castExpr(productionList[2].node), castExpr(productionList[4].node));"},
                ...
                {{ASTNodeType::EXPR, {ASTNodeType::VARIABLE, TokenType::MINUS_EQUALS, ASTNodeType::EXPR}},
                 "return std::make_shared<BinOpExprNode>(castVariable(productionList[0].node), "
                 "BinOpType::SUBTRACT_EQUAL, castExpr(productionList[2].node));"},
        ...
        //                      return std::make_shared<PrgmNode>(std::vector<StmtNodePtr>
        //                      {castStmt(productionList[0].node)});
        //                  }},
        //
        //                 //  STMT -> EXPR "[SEMICOLON]"
        //                 {{ASTNodeType::STMT, {ASTNodeType::EXPR, TokenType::SEMICOLON}},
        ...
        //                  [&](const ProductionItemList& productionList) {
        //                      return
        //                      std::make_shared<FloatExprNode>(std::stold(productionList[0].token->contents));
        //                  }},
        //                 //  EXPR -> "[TRUE]"
        ...
        //                 //  EXPR -> EXPR "[QUESTION]" EXPR "[COLON]" EXPR
        //                 {{ASTNodeType::EXPR,
        //                   {ASTNodeType::EXPR, TokenType::QUESTION, ASTNodeType::EXPR, TokenType::COLON,
        //                   ASTNodeType::EXPR}},
        //                  [&](const ProductionItemList& productionList) {
        //                      return std::make_shared<TernaryExprNode>(castExpr(productionList[0].node),
        //                                                               castExpr(productionList[2].node),
        ...
        //                 {{ASTNodeType::EXPR, {ASTNodeType::EXPR, TokenType::EXPONENTIATE, ASTNodeType::EXPR}},
        //                  [&](const ProductionItemList& productionList) {
        //                      return std::make_shared<BinOpExprNode>(castExpr(productionList[0].node),
        //                      BinOpType::EXPONENTIATE,
        //                                                             castExpr(productionList[2].node));
        //                  }},
        //                 //  EXPR -> EXPR "[MULTIPLY]" EXPR
        //                 {{ASTNodeType::EXPR, {ASTNodeType::EXPR, TokenType::MULTIPLY, ASTNodeType::EXPR}},
        ...
        //
        //                 //  EXPR -> VARIABLE "[EXPONENTIATE_EQUALS]" EXPR
        //                 {{ASTNodeType::EXPR, {ASTNodeType::VARIABLE, TokenType::EXPONENTIATE_EQUALS,
        //                 ASTNodeType::EXPR}},
        //                  [&](const ProductionItemList& productionList) {
        //                      return std::make_shared<BinOpExprNode>(castVariable(productionList[0].node),
        ...
        //                  }},
        //                 //  EXPR -> VARIABLE "[MULTIPLY_EQUALS]" EXPR
        //                 {{ASTNodeType::EXPR, {ASTNodeType::VARIABLE, TokenType::MULTIPLY_EQUALS,
        //                 ASTNodeType::EXPR}},
        //                  [&](const ProductionItemList& productionList) {
        //                      return std::make_shared<BinOpExprNode>(castVariable(productionList[0].node),
        ...
        //                  }},
        //                 //  EXPR -> VARIABLE "[DIVIDE_EQUALS]" EXPR
        //                 {{ASTNodeType::EXPR, {ASTNodeType::VARIABLE, TokenType::DIVIDE_EQUALS,
        //                 ASTNodeType::EXPR}},
        //                  [&](const ProductionItemList& productionList) {
        //                      return std::make_shared<BinOpExprNode>(castVariable(productionList[0].node),
        //                                                             BinOpType::DIVIDE_EQUAL,
        ...
        //                  }},
        //                 //  EXPR -> VARIABLE "[MODULO_EQUALS]" EXPR
        //                 {{ASTNodeType::EXPR, {ASTNodeType::VARIABLE, TokenType::MODULO_EQUALS,
        //                 ASTNodeType::EXPR}},
        //                  [&](const ProductionItemList& productionList) {
        //                      return std::make_shared<BinOpExprNode>(castVariable(productionList[0].node),
        //                                                             BinOpType::MODULO_EQUAL,
        ...
        //                  }},
        //                 //  EXPR -> VARIABLE "[MINUS_EQUALS]" EXPR
        //                 {{ASTNodeType::EXPR, {ASTNodeType::VARIABLE, TokenType::MINUS_EQUALS,
        //                 ASTNodeType::EXPR}},
        //                  [&](const ProductionItemList& productionList) {
        //                      return std::make_shared<BinOpExprNode>(castVariable(productionList[0].node),
        ...
        //
        //                 //  VARIABLE -> "[VARIABLE]"
        //                 {{ASTNodeType::VARIABLE, {TokenType::VARIABLE}}, [&](const ProductionItemList&
        //                 productionList) {
        //                      return std::make_shared<IdentVariableNode>(productionList[0].token->contents);
        //                  }}}};
    }
...
//                  [&](const ProductionItemList& productionList) {
//                      return std::make_shared<UnOpExprNode>(UnOpType::POST_DECREMENT,
//                      castExpr(productionList[0].node));
//                  }},
//                 //  EXPR -> "[NOT]" EXPR
...
//                  [&](const ProductionItemList& productionList) {
//                      return std::make_shared<UnOpExprNode>(UnOpType::PRE_INCREMENT,
//                      castExpr(productionList[0].node));
//                  }},
//                 //  EXPR -> "[DECREMENT]" EXPR
//                 {{ASTNodeType::EXPR, {TokenType::DECREMENT, ASTNodeType::EXPR}},
//                  [&](const ProductionItemList& productionList) {
//                      return std::make_shared<UnOpExprNode>(UnOpType::PRE_DECREMENT,
//                      castExpr(productionList[0].node));
//                  }},
//                 //  EXPR -> EXPR "[EXPONENTIATE]" EXPR
//                 {{ASTNodeType::EXPR, {ASTNodeType::EXPR, TokenType::EXPONENTIATE, ASTNodeType::EXPR}},
