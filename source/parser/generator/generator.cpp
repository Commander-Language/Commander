...
namespace Parser {
    ...
    Generator::Generator() {
        //  Wraps the given string in curly braces.
    ...
    Generator::Kernel::Kernel(const Generator::GrammarRule& rule, size_t index, Generator::TokenType lookahead)
    ...
    Generator::State::State(const std::vector<Kernel>& kernels,
    ...
    std::vector<Generator::Kernel> Generator::Closure::operator[](const std::vector<Generator::Kernel>& kernels) {
...
int main(int, char**) {
    ...
    //  Open a file to output the generated parse table.
    //  If the provided filename was `-`, use stdout.
    //  Reference: https://stackoverflow.com/a/366969
    std::ofstream file;
